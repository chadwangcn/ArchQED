# ArchQED repository instructions
...
- Before product work, run `archqed sync --check` and `archqed status --json`.
...
- Never invent missing defaults, data sources, failure behavior, or fallbacks.
